...
\author{Martin Hochman \\
\href{mailto:xhochm07@fit.vutbr.cz}{xhochm07@fit.vutbr.cz}}
\date{}
...
Klasická hladká sazba se doplňuje o~další řezy písma pro zvýraznění důležitých pojmů. Existuje \uv{pravidlo}:

\begin{quotation}
Čím více \emph {druhů}, {\bf řezů}, {\tiny velikostí}, \textcolor{red}{barev} písma a~jiných {\sc efektů} použijeme, tím \verb|profesionálněji| bude {\fontfamily{pzc}\selectfont \Large dokument} vypadat.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{{\tt http://petr.olsak.net/ftp/olsak/vlna/}}}.
